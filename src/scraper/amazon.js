...
function parsePrice(priceText) {
    ...
    else if (priceText.includes('E£') || priceText.includes('EGP')) currency = 'EGP';
...
function validateAmazonUrl(url) {
    ...
    const amazonPattern = /^https?:\/\/(www\.)?(amazon\.(in|com|eg|co\.uk|de|fr|es|it|ca|com\.au)|amzn\.(to|in|eu|com))\//i;
